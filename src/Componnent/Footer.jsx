...
const Footer = () => {
  return (
    <div className='h-auto w-full pl-8 pb-3 pt-3 bg-gray-600 text-white grid grid-cols-1  gap-y-10 md:grid-cols-5 md:gap-x-2 md:pt-8 md:pl-2'>
     ...
     <div className='flex items-start justify-start h-40'>
        ...
        <div className='flex flex-col items-start justify-start gap-4 text-md '>
            <span>Share your Rosewater story with us</span>
            <span className='font-bold'>#ROSEWATERMV</span>
            <div className='flex  items-start justify-start gap-4 text-6xl text-orange-500 '>
